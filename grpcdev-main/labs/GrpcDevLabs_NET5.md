...
- define a *message* called "RegisterRequest" containing fields for:
	...
	- "picture", type *bytes*
	- "subscriptionType", type *MemberType*
	- repeated field "familymember", type *string*
- define a *message* called "RegisterReply" containing fields for:
	- "welcome", type *string*
	- "price", type *uint32*
	- "confirmedAge", type *Duration*
	- repeated field "subscriptionKey", type *string*
...
- Create a *RegisterReply* object and set the fields to the right values (do not forget the *confirmedAge*). Return the RegisterReply object.
